...
<template>
    <AppTopbar :app-name="globalConfig.appName">
        ...
        <template #topbarMenu>
            <Button class="m-0 p-0 layout-menu-button topbar-button focus:shadow-none" icon="pi pi-bookmark" rounded
                    severity="secondary" size="large" text/>
            <Button class="m-0 p-0 layout-menu-button topbar-button focus:shadow-none" icon="pi pi-search" rounded
